...
/// One of Franklin's virtues (or a custom virtue surfaced through the same shape).
struct Virtue: Identifiable, Hashable {
    let id: String
    let name: String
...
enum Virtues {
    ...
    static func byId(_ id: String?) -> Virtue? {
